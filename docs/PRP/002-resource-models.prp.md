...
All billable resources are located under files locarted in `docs/PRP/resources/`, read them carefully for resource-specific rules and billing nuances.

for v1 we are defining these two resource types:
